...
export default function App() {
  ...
  <>
    <div
      role="status"
      className="flex flex-col items-center justify-start h-screen w-full pt-80"
    >
      <svg
        aria-hidden="true"
      ...
      <p className="mt-0 text-center">Yükleniyor...</p>
      <p className="text-center">Servis uyku modundaysa bu bir veya iki dakikanızı alabilir...</p>
    </div>
